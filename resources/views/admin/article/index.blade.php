                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'visible'">{{ trans('admin.article.columns.visible') }}</th>
                                        <th is='sortable' :column="'title'">{{ trans('admin.article.columns.title') }}</th>
                                        <th is='sortable' :column="'subHeadline'">{{ trans('admin.article.columns.subHeadline') }}</th>
                                        <th is='sortable' :column="'article'">{{ trans('admin.article.columns.article') }}</th>
                                        <th is='sortable' :column="'image'">{{ trans('admin.article.columns.image') }}</th>
                                        <th is='sortable' :column="'video'">{{ trans('admin.article.columns.video') }}</th>
                                        <th is='sortable' :column="'audio'">{{ trans('admin.article.columns.audio') }}</th>
                                        <th is='sortable' :column="'videoUrl'">{{ trans('admin.article.columns.videoUrl') }}</th>
                                        <th is='sortable' :column="'audioUrl'">{{ trans('admin.article.columns.audioUrl') }}</th>
                                        <th is='sortable' :column="'file'">{{ trans('admin.article.columns.file') }}</th>
